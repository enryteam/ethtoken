...
contract Token is IToken, Utils {
    /* 公共变量 */
    string public standard = 'http://www.dcepro.hk';
    string public name = '大牛币'; //代币名称
    string public symbol = 'ENRY'; //代币符号比如'$'
    uint8 public decimals = 8;  //代币单位 小数点位数
    uint256 public totalSupply = 100000000; //代币总量
